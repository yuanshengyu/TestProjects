...
namespace TestCompression
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            StringBuilder sourceStringBuilder = new StringBuilder(sourceString.Length * 100);
            for (int i = 0; i < 100; i++)
            {
                sourceStringBuilder.Append(sourceString);
            }
            sourceString = sourceStringBuilder.ToString();
