...
namespace CLRProfiler
{
    ...
    public class MainForm : System.Windows.Forms.Form
    {
            ...
            if (arguments.Length > 0)
            {
                ...
                switch (arguments[0])
                {
                    ...
                    case "/attach":
                        ...
                        if (attachProfiler(pid, GetLogFileName(pid)) )
                        {
                            Console.WriteLine("The logging data is saved at " + GetLogFileName(pid) + ".");
                        }
                        else
                        {
                            Environment.ExitCode = 1;
                    ...
                    case "/detach":
                        ...
                        NamedManualResetEvent detachEvent = new NamedManualResetEvent(string.Format("{0}_{1:x8}", "Global\\OMV_Detach", pid), false, false);

                        if (!detachEvent.IsValid())
                        {
        ...
        private void InitializeComponent()
        {
            ...
            this.profilingActiveCheckBox.Location = new System.Drawing.Point(167, 15);
            ...
            this.groupBox1.Location = new System.Drawing.Point(163, 48);
            ...
            // 
            this.setCommandLineMenuItem.Index = 8;
            ...
            // 
            this.profileASP_NETmenuItem.Index = 5;
            ...
            // 
            this.killApplicationButton.Location = new System.Drawing.Point(15, 121);
            this.killApplicationButton.Name = "killApplicationButton";
            this.killApplicationButton.Size = new System.Drawing.Size(135, 24);
            ...
            this.startApplicationButton.Size = new System.Drawing.Size(135, 24);
            ...
            // 
            this.attachProcessMenuItem.Index = 3;
            ...
            this.detachProcessMenuItem.Index = 4;
            ...
            // 
            this.profileServiceMenuItem.Index = 6;
            ...
            // showHeapButton
            // 
            this.showHeapButton.Location = new System.Drawing.Point(15, 148);
            this.showHeapButton.Name = "showHeapButton";
            this.showHeapButton.Size = new System.Drawing.Size(135, 24);
            ...
            // attachProcessButton
            // 
            this.attachProcessButton.Location = new System.Drawing.Point(15, 66);
            this.attachProcessButton.Name = "attachProcessButton";
            this.attachProcessButton.Size = new System.Drawing.Size(135, 24);
            ...
            this.groupBox2.Location = new System.Drawing.Point(164, 118);
            ...
            this.detachProcessButton.Location = new System.Drawing.Point(15, 93);
            this.detachProcessButton.Name = "detachProcessButton";
            this.detachProcessButton.Size = new System.Drawing.Size(135, 24);
            ...
            // startURLButton
            // 
            this.startURLButton.Location = new System.Drawing.Point(15, 39);
            this.startURLButton.Name = "startURLButton";
            this.startURLButton.Size = new System.Drawing.Size(135, 24);
        ...
        private void ResetStateAfterProfilingStopped()
        {
            ...
            startApplicationButton.Enabled = startURLButton.Enabled = allocationsCheckBox.Enabled = callsCheckBox.Enabled = targetCLRVersioncomboBox.Enabled = true;
            detachProcessButton.Enabled = showHeapButton.Enabled = killApplicationButton.Enabled = false;
            logFileOpenMenuItem.Enabled = profileApplicationMenuItem.Enabled = startURLMenuItem.Enabled = attachProcessMenuItem.Enabled = profileASP_NETmenuItem.Enabled = profileServiceMenuItem.Enabled = setCommandLineMenuItem.Enabled = true;
        ...
        private void attachProcessButton_Click(object sender, EventArgs e)
        {
            ...
            if (attachProfiler(attachTargetPID, GetLogFileName(attachTargetPID)))
            {
        ...
        private void detachProcessButton_Click(object sender, EventArgs e)
        {
            ...
            NamedManualResetEvent detachEvent = new NamedManualResetEvent(string.Format("{0}_{1:x8}", "Global\\OMV_Detach", attachTargetPID), false, false);

            if (!detachEvent.IsValid())
            {
                MessageBox.Show("Cannot request detach.  Wrong PID?", "Failure");
                return;
            }
